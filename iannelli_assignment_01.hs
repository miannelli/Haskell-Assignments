...
-- making the time complexity quadratic (O(a^2)).		
...
-- The code is clean and elegant.  I like how the code resembles mathematical
-- definitions.  List comprehensions look like set comprehensions in math.
-- The guards look like you are defining a function.  Fewer if statements.
-- Code is concise and not as messy.
-- What I didn't like was the increased difficulty of properly analyzing my code.
-- In a procedural language, it is much easier to accomplish this, since you are
-- giving instructions to the computer.  FWith functional programming, you have to
...
--		About 10 hours, probably 5 of which were spent reading the haskell book, the
--		rest were spent doing the assignment.
-- 2. Would you rate it as easy, moderate, or difficult?
-- A. 	I would say it is moderate difficulty for a beginner.  Nothing really felt
